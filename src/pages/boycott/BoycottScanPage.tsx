...
const CameraScanner = ({ onDetected, onManualEntry }: { onDetected: (code: string) => void; onManualEntry: () => void }) => {
  ...
  const startScanner = useCallback(async () => {
    ...
    try {
      ...
      console.log("[BoycottScan] Start scanner clicked");
    ...
    return (
      <div className="rounded-2xl bg-card p-6 shadow-sm border border-border text-center">
        ...
        <button
          ...
          className="mt-3 w-full rounded-xl bg-gradient-to-r from-red-700 to-red-900 py-3 text-sm font-medium text-white shadow-md"
        >
