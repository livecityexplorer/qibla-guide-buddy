...
const QiblaPage = () => {
  ...
  const qiblaDirection = 136; // Example: Qibla from a western location
  ...
  return (
    <div className="min-h-screen">
      <div className="gradient-emerald px-4 pb-8 pt-12 islamic-pattern">
        ...
        <h1 className="text-2xl font-bold text-primary-foreground">Qibla Direction</h1>
        <p className="mt-1 text-sm text-primary-foreground/70">Find the direction of the Kaaba</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center px-4 pt-12">
        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-xs font-semibold text-accent">Kaaba</p>
          </div>
        </motion.div>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            {permissionGranted ? "Point your phone to find Qibla" : "Enable compass on your device"}
          </p>
        </div>
        ...
        {!permissionGranted && (
          <button
            ...
            className="mt-6 rounded-xl gradient-emerald px-6 py-3 font-medium text-primary-foreground shadow-emerald"
          >
            Enable Compass
          </button>
        )}
